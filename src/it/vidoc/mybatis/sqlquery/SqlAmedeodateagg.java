...
import it.vidoc.mybatis.javaclient.ext.AmedeodateaggMapperExt;
import it.vidoc.mybatis.javamodel.ext.AmedeodateaggExt;
import it.vidoc.utils.MyBatisConnectionFactory;

public class SqlAmedeodateagg implements ISqlGeneric {
	...
	public List<AmedeodateaggExt> selectDateAgg() {
		AmedeodateaggMapperExt amedeodateaggMapperExt = MyBatisConnectionFactory.getSqlSession().getMapper(AmedeodateaggMapperExt.class);
		List<AmedeodateaggExt> listDateAgg = amedeodateaggMapperExt.selectDateAgg();
